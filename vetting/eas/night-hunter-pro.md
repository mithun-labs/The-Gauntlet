...
# Night Hunter Pro
*Commercial closed-source night-scalping FX EA with an accountable vendor and a 4+ year real-money record — Avoid, because the record is uninspectable here, ROR is NON-ESTIMABLE, and ~30% DD is prop-incompatible.*
...
| **Verdict** | ⛔ **AVOID** |
| **Overall** | **2.7 / 10** · poor |
| **Mechanism** | night-scalping / mean-reversion · confidence Medium · Gate B: verifiable |
| **Evidence** | ◉ best_tier **T2** · real money · 4+ years · independent reviews referencing Myfxbook |
| **Risk of ruin** | NON-ESTIMABLE |
| **Legality** | FN ⚠️ · FP ⚠️ · 5% ⚠️ · TFT ⚠️ (all Conditional) |
| **Verified perf** | ~2–3%/mo [T2] · max DD ~30% (verified) [T2] · 4+ years real money |
| **Vendor** | Valeriia Mishchenko / "ValeryTrading" — identifiable |

> **Bottom line — binding criterion:** ROR NON-ESTIMABLE and best_tier ≤ TIER2 (deterministic); reinforced by ~30% verified max DD (prop-incompatible), broker/rollover-spread-dependent edge, and The 5%ers rollover-exploitation legality risk.
...
|-----------|:------:|:------:|:----------------:|:--------:|:------------:|
| Funded-Account Survival | 30% | 4 | × 0.20 (ROR cap) = 0.8 → clamp | **1** | 0.30 |
| Prop-Firm Compliance | 20% | 4 | not multiplied (Conditional all firms) | **4** | 0.80 |
| Risk Management | 15% | 5 | no extra cap | **5** | 0.75 |
| Challenge-Passing | 15% | 5 | × 0.45 (A, Tier2) = 2.25 | **2** | 0.30 |
| Consistency | 10% | 4 | × 0.60 (B, Tier2) = 2.4 | **2** | 0.20 |
| Transparency | 5% | 5 | × 0.60 (B, Tier2) = 3.0 | **3** | 0.15 |
| Profitability | 5% | 5 | × 0.60 (B, Tier2) = 3.0 | **3** | 0.15 |
| **Overall** | | | | | **2.7** |
